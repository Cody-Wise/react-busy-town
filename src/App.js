  ...
  return (
    <div className="App">
      <div className="fight">
        <div className="monster">
          ...
          <div className='buttons'>
            ...
            <button onClick={()=> setAlienSize(alienSize + sizeModifier)}>Oh no! The alien is gobblin up all the electricity!</button>
            {/* when you click this button, the lizard's size in state should go down by one */}
            <button onClick={()=> setLizardSize(lizardSize - sizeModifier)} >Amazing! The alien zapped the lizard!</button>
          </div>
        </div>
        <div className="monster">
          ...
          <div className="buttons">
            ...
            <button onClick={()=> setLizardSize(lizardSize + sizeModifier)}>Yegads! The lizard is ramping up to its final form!</button>
            {/* when you click this button, the alien's size in state should go up by one */}
            <button onClick={()=> setAlienSize(alienSize - sizeModifier)}>Oh my! The lizard chomped down on the alien!</button>
          </div>
        </div>
      </div>
      ...
      <div className="buttons">
        ...
        <button onClick={()=> {setLightColor('green');traffic.pop(); setTraffic([...traffic]);}}>Green</button>;
      </div>
      {/* 
